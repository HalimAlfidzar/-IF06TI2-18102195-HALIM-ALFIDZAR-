package com.halim_18102195.praktikum8
...
class SmsReceiverActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val senderNo = intent.getStringExtra(com.halim_18102195.praktikum8.SmsReceiverActivity.EXTRA_SMS_NO)
        val senderMessage = intent.getStringExtra(com.halim_18102195.praktikum8.SmsReceiverActivity.EXTRA_SMS_MESSAGE)
