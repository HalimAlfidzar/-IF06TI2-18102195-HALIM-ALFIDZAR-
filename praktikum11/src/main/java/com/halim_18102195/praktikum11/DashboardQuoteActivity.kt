package com.halim_18102195.praktikum11
...
import com.halim_18102195.praktikum11.adapater.QuoteAdapter
import com.halim_18102195.praktikum11.data.Quote
import com.halim_18102195.praktikum11.databinding.ActivityDashboardQuoteBinding
import com.halim_18102195.praktikum11.helper.REQUEST_ADD
import com.halim_18102195.praktikum11.helper.REQUEST_UPDATE
import com.halim_18102195.praktikum11.helper.RESULT_ADD
import com.halim_18102195.praktikum11.helper.RESULT_DELETE
import com.halim_18102195.praktikum11.helper.RESULT_UPDATE
        ...
        GlobalScope.launch(Dispatchers.Main) {
            ...
            firestore.collection("quotes")
                ...
                .addOnSuccessListener { result ->
                    ...
                    for (document in result) {
                        ...
                        val category = document
                            ...
                            .toString()
                        val date = document
                            .get("date") as com.google.firebase.Timestamp
                ...
                .addOnFailureListener { exception ->
                    progressbar.visibility = View.INVISIBLE
                    Toast.makeText( this@DashboardQuoteActivity, "Error adding document",
                        Toast.LENGTH_SHORT )
                        .show()
                }
        }
